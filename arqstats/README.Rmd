...
<!-- badges: start -->
[![GitHub issues](https://img.shields.io/github/issues/gualapuromoises/ikiam_metagenomics)](https://github.com/gualapuromoises/ikiam_metagenomics/issues)
[![GitHub pulls](https://img.shields.io/github/issues-pr/gualapuromoises/ikiam_metagenomics)](https://github.com/gualapuromoises/ikiam_metagenomics/pulls)
<!-- badges: end -->
...
And the development version from [GitHub](https://github.com/gualapuromoises/ikiam_metagenomics) with:

```{r 'install_dev', eval = FALSE}
BiocManager::install("gualapuromoises/ikiam_metagenomics")
```
## Example
